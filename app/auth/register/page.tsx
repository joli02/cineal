...
export default function RegisterPage() {
  ...
  if (success) return (
    <div style={{ background: '#0a0a0f', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans', sans-serif" }}>
      <div style={{ background: '#12121a', border: '1px solid rgba(34,197,94,0.2)', borderRadius: '12px', padding: '40px', maxWidth: '420px', textAlign: 'center' }}>
        <div style={{ fontSize: '56px', marginBottom: '16px' }}>{gender === 'female' ? '👩' : '👤'}</div>
  ...
  return (
    <div style={{ background: '#0a0a0f', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans', sans-serif", padding: '20px' }}>
      ...
      <div style={{ background: '#12121a', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px', padding: '36px', width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              ...
              <button type="button" onClick={() => setShowPassword(!showPassword)}
                style={{ position: 'absolute', right: '12px', background: 'none', border: 'none', color: '#6b6b80', cursor: 'pointer', display: 'flex', padding: 0 }}>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              <input value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                ...
                style={{
                  ...
                  borderColor: confirmPassword && password !== confirmPassword ? 'rgba(229,9,20,0.5)' : 'rgba(255,255,255,0.08)',
                }} />
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
              {[
                { value: 'male', label: 'Mashkull', icon: '👤' },
                { value: 'female', label: 'Femër', icon: '👩' },
              ].map(opt => (
