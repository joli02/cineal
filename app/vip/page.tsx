...
const PLANS = [
  {
    ...
    days: 30,
    popular: false,
    features: ['Pa reklama', 'HD 1080p', 'Titra shqip', 'Watchlist e pakufizuar', 'Historiku i shikimit'],
  },
  {
    id: 'sixmonth',
    name: 'VIP 6 Muaj',
    ...
    features: ['Pa reklama', 'HD 1080p', 'Titra shqip', 'Watchlist e pakufizuar', 'Historiku i shikimit', 'Akses i hershëm'],
  },
  {
    id: 'year',
    name: 'VIP 1 Vit',
    ...
    features: ['Pa reklama', 'HD 1080p', 'Titra shqip', 'Watchlist e pakufizuar', 'Historiku i shikimit', 'Akses i hershëm', 'Badge VIP special'],
  },
]

const CONTACT_EMAIL = 'info' + '@' + 'cineal.stream'
const PAYPAL_LINK = 'https://www.paypal.com/paypalme/cineal'
          ...
          <div style={{ background: '#12121a', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px', padding: '32px' }}>
            ...
            <div style={{ background: 'rgba(245,166,35,0.08)', border: '1px solid rgba(245,166,35,0.2)', borderRadius: '8px', padding: '16px', marginBottom: '24px' }}>
              ...
              <div style={{ fontSize: '13px', color: '#b0b0c0', lineHeight: 1.8 }}>
                ...
                <div>2. Dërgo <strong style={{ color: '#fff' }}>{selectedPlan.price} ALL</strong></div>
            ...
            <div style={{ textAlign: 'center', fontSize: '12px', color: '#6b6b80', marginBottom: '20px' }}>
              Pas pagesës kontakto: <strong style={{ color: '#b0b0c0' }}>{CONTACT_EMAIL}</strong>
            </div>
            <div style={{ background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.2)', borderRadius: '8px', padding: '12px', fontSize: '12px', color: '#22c55e', marginBottom: '20px' }}>
              ✓ Na kontakto me emailin tënd dhe e aktivizojmë VIP-in menjëherë!
            </div>
