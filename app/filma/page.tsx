    ...
    <div style={{ background: '#0a0a0f', minHeight: '100vh', color: '#fff', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: 'clamp(16px, 4vw, 32px)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
          <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(24px, 5vw, 32px)', letterSpacing: '3px' }}>
            {genre || 'Filma'}
          </h1>
        ...
        <div style={{ position: 'relative', marginBottom: '14px' }}>
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            style={{ width: '100%', background: '#12121a', border: '1px solid rgba(255,255,255,0.08)', color: '#fff', padding: '10px 16px 10px 44px', borderRadius: '6px', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }} />
        </div>
